...
class TestScraper(unittest.TestCase):
    ...
    def test_scraper_succesfully_scrapes_valid_key_statistics_url(self):
        ...
        self.assertTrue(test_scraper.financials_dict['Gross Profits'] == '96.94B')
    ...
    def test_scraper_raises_ticker_error_for_invalid_key_statistics_url_text(self):
        test_data = os.path.join(self.data_dir, INVALID_KEY_STATISTICS_URL_TEXT_FILE_NAME)
        test_requester = TestScraper.get_test_requester(test_data)
        test_scraper = TestScraper.get_test_scraper(test_requester)
